    ...
    <div className="container mx-auto">
      {loading ? (
        <div className="flex items-center justify-center min-h-[150px]">
          <Loader2 className="animate-spin w-6 h-6 text-primary-500 dark:text-primary-400" />
        </div>
      ) : (
                    ...
                    >
                      {!imageError[book._id] ? (
                        <img
                          ...
                          alt={book.name}
                          className="h-48 w-full object-cover transition-transform duration-500 hover:scale-110 cursor-pointer"
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <button 
                      ...
                      className="bg-primary-50 dark:bg-secondary-700 text-primary-700 dark:text-primary-400 px-2 py-1 text-xs rounded hover:bg-primary-100 dark:hover:bg-secondary-600 transition-all duration-300 inline-flex items-center gap-1"
                    >
                    ...
                    <button 
                      ...
                      className="bg-primary-700 dark:bg-primary-800 text-white px-4 py-2 rounded-lg hover:bg-primary-800 dark:hover:bg-primary-900 transition-colors duration-300 font-medium flex items-center justify-center space-x-2"
                    >
                    ...
                    <button 
                      ...
                      className="bg-primary-600 dark:bg-primary-700 text-white px-4 py-2 rounded-lg hover:bg-primary-700 dark:hover:bg-primary-800 transition-colors duration-300 font-medium flex items-center justify-center space-x-2"
                    >
                      {isGeneratingSummary ? (
                        <>
