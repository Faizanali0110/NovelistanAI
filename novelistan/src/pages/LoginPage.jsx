              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="relative group">
                  <input
                    ...
                    required
                  />
                  <Lock className="w-4 h-4 text-gray-400 absolute right-8 top-1/2 transform -translate-y-1/2 group-hover:text-yellow-500 transition-colors" />
                  <button
                    type="button"
                    tabIndex={0}
                ...
                <button
                  type="submit"
                  className={`w-full py-2 text-sm rounded-lg transition-all duration-300 ${
                    !selectedRole
